...
| [Context7](https://github.com/upstash/context7) | Up-to-date code documentation for LLMs | Free | ![GitHub stars](https://img.shields.io/github/stars/upstash/context7?style=flat) |
...
| Name | Description | Pricing | Stars |
|------|-------------|---------|-------|
| [ElevenLabs MCP](https://github.com/elevenlabs/elevenlabs-mcp) | Official ElevenLabs TTS server | Freemium | ![GitHub stars](https://img.shields.io/github/stars/elevenlabs/elevenlabs-mcp?style=flat) |
...
| Name | Description | Pricing | Stars |
|------|-------------|---------|-------|
| [AntV Charts MCP](https://github.com/antvis/mcp-server-chart) | 25+ visual charts using AntVis | Free | ![GitHub stars](https://img.shields.io/github/stars/antvis/mcp-server-chart?style=flat) |
...
| Name | Description | Pricing | Stars |
|------|-------------|---------|-------|
| [E2B MCP](https://github.com/e2b-dev/mcp-server) | Code execution sandbox | Freemium | ![GitHub stars](https://img.shields.io/github/stars/e2b-dev/mcp-server?style=flat) |
